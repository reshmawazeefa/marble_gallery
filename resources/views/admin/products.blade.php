                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                        <label for="customer" class="form-label">Category</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                        <label for="from_date" class="form-label">Subcategory</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                        <label for="to_date" class="form-label">Type</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                    <label for="customer" class="form-label">Brand</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                    <label for="customer" class="form-label">Size</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                    <label for="customer" class="form-label">Color</label>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="me-3">
                                    <label for="customer" class="form-label">Finish</label>
                                    <select name="finish" class="finishSelect form-control select2">
                                    </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6" style="padding-top: 28px;">
                                    <div class="me-3">
